...
const mainPagePath = ["pages/index"];
//返回首页的地址
const homePath = "/pages/index";
//白色表达值
...
.header {
	...
	&.colorWhite {
		.left_info {
			...
			.back {
				background-image: url('./icon_back_white.png');
			}
			text {
				background-color: rgba(255, 255, 255, 0.3);
			}
			.home {
				background-image: url('./icon_home_white.png');
			}
		}
	}
	.left_box {
	...
	.left_info {
		...
		.back {
			background-image: url('./icon_back_black.png');
